<template>
  <v-dialog :value="active" persistent :width="type===uploadType.TRICK?'930':'750'">
    <!--        STEPPER-->
    <v-stepper v-model="step">
      <v-stepper-header>
        ...
        <v-stepper-step v-if="type===uploadType.TRICK" :complete="step > 2" step="2">Submission Information
        </v-stepper-step>
        ...
        <v-stepper-step :complete="step > 4" step="4">Trick Information</v-stepper-step>
      ...
      <div class="d-flex justify-center my-2">
        <v-btn color="red darken-1" @click="toggleActivity">Close</v-btn>
      </div>
    </v-stepper>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ...mapActions('tricks', ['fetchTricks']),
      ...mapActions('submissions', ['fetchSubmissions']),
